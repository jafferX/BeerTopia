...
//
//    var data = ListOfBeersModel.FromJson(jsonString);
//
namespace BeerTopia.Models
{
    ...
    public partial class ListOfBeersModel
    {
    ...
    public partial class ListOfBeersModel
    {
        public static ListOfBeersModel FromJson(string json) => JsonConvert.DeserializeObject<ListOfBeersModel>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ListOfBeersModel self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
